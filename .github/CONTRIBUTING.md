<pre style="word-wrap: break-word; white-space: pre-wrap;"># AwesomeQRCode Contribution Guide
...
If you want to contribute but aren't sure where to start, you can create a [new discussion](https://github.com/ubinatus/awesome-qrcode/discussions).
...
It's never a fun experience to have your pull request declined after investing a lot of time and effort into a new feature. To avoid this from happening, we request that contributors create [a feature request](https://github.com/ubinatus/awesome-qrcode/discussions/new?category=ideas) to first discuss any API changes or significant new ideas.
...
This will run the documentation site on [localhost:3000](http://localhost:3000).

The documentation site code is located in [`apps/docs`](../apps/docs). Make sure you clean up after yourself before pushing up any changes.

All API changes should also include updates to [`README.md`](../README.md) and the documentation site. Documentation is crucial to helping developers of all experience levels use the library.

## Coding standards

Our code formatting rules are defined in [`.eslintrc.js`](../.eslintrc.js). You can check your code against these standards by running:
...
#### If you published `@awesome-qrcode/react`:

- Go to [GitHub’s new release form.](https://github.com/ubinatus/awesome-qrcode/releases/new)
- Select the latest version tag for `@awesome-qrcode/react`.
- Set the title to `@awesome-qrcode/react@x.x.x` (substituting the latest version)
- Copy the Markdown content below the latest version heading from [`CHANGELOG.md`](../packages/react/CHANGELOG.md)

If at any stage you’re unsure of the formatting, you can [reference past releases.](https://github.com/ubinatus/awesome-qrcode/releases)
